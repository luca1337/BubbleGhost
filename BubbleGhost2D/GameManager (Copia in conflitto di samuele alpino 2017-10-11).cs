    ...
    public sealed class GameManager : Behaviour, IUpdatable
    {
        ...
        private class StateGameSetup : IState
        {
            ...
            public void OnStateEnter( )
            {
                ...
                owner.userInterface.Add( new UI( owner.ghost.GetComponent< Lifes >( ).LifesMax.ToString(), FlyWeight.Get( "Font" ), Engine.Half ) );
        ...
        private class StateGameLoop : IState
        {
            ...
            public IState OnStateUpdate()
            {
                ...
                if ( Engine.CheckTrigger(owner.bubble.GetComponent < Box2D >( ) ) )
                {
                    Engine.Boxes.Clear();
                    Engine.levelColliders.Clear();
